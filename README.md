...
![3.0.5](https://img.shields.io/badge/Current_Release-3.0.5-27AAE0?style=for-the-badge)
![3.0.6](https://img.shields.io/badge/Current_Snapshot-3.0.6--SNAPSHOT-27AAE0?style=for-the-badge)
...
```groovy
dependencies {
    implementation 'io.nats:jnats-json:3.0.5'
}
```
...
dependencies {
   implementation 'io.nats:jnats-json:3.0.6-SNAPSHOT'
}
```
